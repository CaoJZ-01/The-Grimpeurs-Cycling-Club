    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBackToAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SelectClub.this, ParticipateMain.class);
        ...
        listToSelect.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                String clubToRate = (String) list.get(i);
                String userid= extra.getString("userid");
                Intent intent=new Intent(SelectClub.this, RateClub.class);
                intent.putExtra("userid",userId);
                intent.putExtra("clubToRate",clubToRate);
    ...
    public void onStart() {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                EventTypeListAdapter adapter = new EventTypeListAdapter(SelectClub.this, list);
