...
public class SelectEventType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBackToAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SelectEventType.this, CyclingClub_Main.class);
        ...
        listToSelect.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                loginRepository.findEventTypeInfo(eventTypeToSelect, new Callback() {
                    @Override
                    public void onFetched(Object obj) {
                        EventType eventType=(EventType)obj;
                        Bundle extra=getIntent().getExtras();
                        String userid= extra.getString("userid");
                        Intent intent=new Intent(SelectEventType.this, CreateEvent.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        intent.putExtra("userid",userId);
    ...
    public void onStart() {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                EventTypeListAdapter adapter = new EventTypeListAdapter(SelectEventType.this, list);
