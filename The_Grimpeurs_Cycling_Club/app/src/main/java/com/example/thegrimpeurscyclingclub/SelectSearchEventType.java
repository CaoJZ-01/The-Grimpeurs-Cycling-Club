...
public class SelectSearchEventType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBackToAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SelectSearchEventType.this, ParticipateMain.class);
        ...
        listToSelect.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                String eventTypeToSelect = (String) list.get(i);
                LoginRepository loginRepository=new LoginRepository();
                loginRepository.searchEventByType(eventTypeToSelect, new Callback() {
                    @Override
                    public void onFetched(Object obj) {
                        ArrayList<String> events=(ArrayList<String>)obj;
                        Bundle extra=getIntent().getExtras();
                        String userid= extra.getString("userid");
                        Intent intent=new Intent(SelectSearchEventType.this, ShowEvents.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        intent.putExtra("userid",userId);
    ...
    public void onStart() {
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                EventTypeListAdapter adapter = new EventTypeListAdapter(SelectSearchEventType.this, list);
